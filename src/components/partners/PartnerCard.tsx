...
export function PartnerCard({
  ...
  return (
    <Card
      ...
      className={`group transition-all duration-200 outline-none cursor-pointer ${
        isSelected
      ...
      <CardContent className="space-y-4 px-5 pb-5 pt-0">
          ...
          {typeof partner.avgProcessingDays === "number" && (
            <div className="flex items-center gap-2 rounded-lg bg-muted/40 p-2.5 border border-border/40 text-xs text-muted-foreground">
              ...
              <div>
                ...
                <span className="text-[11px]">{t("partners.processingTime", { days: partner.avgProcessingDays })}</span>
              </div>
            </div>
          )}
        </div>
        ...
        >
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            className="h-9 text-xs font-medium gap-1.5 min-h-[36px]"
          >
            <a
              href={directionsUrl}
              target="_blank"
